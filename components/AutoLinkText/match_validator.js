...
/* Taken from https://github.com/schneidmaster/react-autolink-text/blob/master/src/match_validator.js */
...
function isValidUriScheme(uriSchemeMatch) {
  const uriScheme = uriSchemeMatch.match(uriSchemeRegex)[0].toLowerCase();
...
function isInvalidProtocolRelativeMatch(protocolRelativeMatch) {
  return (
    ...
    invalidProtocolRelMatchRegex.test(protocolRelativeMatch)
  );
}
