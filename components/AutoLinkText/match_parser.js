...
/* Taken from https://github.com/schneidmaster/react-autolink-text/blob/master/src/match_parser.js */
...
export default function (text, disableUrlStripping = false) {
  ...
  while ((match = regex.exec(text)) !== null) {
    ...
    if (protocolRelativeMatch) {
      const charBeforeMatch =
        protocolRelativeMatch.match(charBeforeProtocolRelMatchRegex)[1] || '';
